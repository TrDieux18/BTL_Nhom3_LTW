...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/admin/font/fontawesome-free-6.7.2-web/fontawesome/css/all.min.css" />
</head>
<body>
                                ...
                                <li id="userLoginLi" style="display: none; position: relative;"><span id="userLogin" style="cursor:pointer;"><i class="fa-solid fa-circle-user nav-icon"></i>
                                    ...
                                    <div id="userDropdown" class="user-dropdown" style="display:none;">
                                        <ul>
                                            ...
                                            <li class="logout"><a href="#" id="logoutBtn"><i class="fa-solid fa-right-from-bracket"></i> Đăng xuất</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
...
<!-- Nội dung body để kiểm tra cuộn -->
<div class="content">
    <h1>Trang web bán vé máy bay</h1>
    <p>Cuộn xuống để thấy navbar đổi màu và logo đổi thành đỏ.</p>
    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
    <!-- Nội dung giả để kéo dài trang -->
    <div style="height: 2000px;">
        <p>Nội dung dài để kiểm tra cuộn...</p>
    </div>
</div>

<script src="${pageContext.request.contextPath}/admin/js/navbar.js"></script>
<script src="${pageContext.request.contextPath}/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
<script src="${pageContext.request.contextPath}/vendor/bootstrap/js/jquery.slim.min.js"></script>
<!-- Phần nội dung ở đây -->
