...
public class HotelDAO extends DBContext {
    ...
    public void insertBooking(String userId, int hotelId, String hotelName, String checkIn, String checkOut,
            String bookingDate, int roomQuantity, String note, Long totalPrice) {

        String sql = "INSERT INTO hotel_booking (user_id, hotel_id, checkin_date, checkout_date, "
                + "booking_date, room_quantity, notes, total_price) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
