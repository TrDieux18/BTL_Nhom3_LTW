...
public class RemoveFromCartServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("hotelId") != null ? request.getParameter("hotelId") : request.getParameter("id");
        ...
        if (type != null && id != null) {
            ...
            cookie.setPath("/"); // Quan trọng: đảm bảo path đúng để xóa được cookie
