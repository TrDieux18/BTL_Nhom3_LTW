...
public class BookingHistoryServlet extends HttpServlet {
    ...
    if ("updateStatus".equals(action)) {
        ...
        BookingHistoryDAO dao = new BookingHistoryDAO(); // Hoặc bạn đang dùng DAO nào
        dao.updateStatus(bookingId, newStatus);

        response.sendRedirect(request.getContextPath() + "/bookingHistory?tab=bookingHistory&action=search");
    }
}
}
