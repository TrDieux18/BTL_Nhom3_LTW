...
<body>
    ...
    <section class="search-hotel">
        ...
        <div class="bg-white p-2 rounded shadow-sm border" style="max-width: 700px;max-height: 100px; margin:auto;">
            <h6 style="font-size:30px; color: var(  --color-red); text-align: center;">Xin chào ! Airpaz luôn sẵn sàng giúp đỡ bạn.</h6>
        </div>
        </div>
    </section>
    ...
    <div class="d-flex justify-content-center align-items-center w-100" style="min-height: 50vh;">
        <div class="col-lg-5 col-md-8 col-10 mx-auto">
            <form id="myForm" action="https://formsubmit.co/fe5ba134fe44634e3559cb80355c3088 " method="POST" enctype=multipart/form-data>
                ...
                <div class="support-card">
                  <h5>Gửi yêu cầu của bạn</h5>
                    ...
                    <div class="mb-3" id="emailField" style="display: none;">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="diachiemail@email.com">
                    </div>
