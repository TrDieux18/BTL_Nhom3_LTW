    ...
    .btn {
     ...
     List<Object[]> stats = (List<Object[]>) request.getAttribute("statistics");
                        ...
                        <div class="tab-content" id="bookingHistory" style="display: none">
                            ...
                            <h3 class="mt-4">📊 Thống kê theo người đặt (Biểu đồ)</h3>
                            ...
                            <h3 class="mt-4">📈 Thống kê theo loại vé (Biểu đồ tròn)</h3>
                            ...
                            <script>
                                const ticketLabels = [
                                <% for (Object[] row : stats) { %>
                                "<%= row[0] %>", // row[0] là loại vé
                                <% } %>
                                ];
                                const ticketData = [
                                <% for (Object[] row : stats) { %>
                                <%= row[2] %>, // row[2] là tổng tiền
                                <% } %>
                                ];
                                const total = ticketData.reduce((sum, val) => sum + val, 0);
                                ...
                                type: 'pie',
                                        ...
                                        plugins: [ChartDataLabels] // BẮT BUỘC phải có
                                });</script>
     ...
     List<Object[]> statsList = (List<Object[]>) request.getAttribute("statistics");
                        ...
                        <div class="tab-content" id="hotelBooking" style="display: none">
                            ...
                            <!-- Biểu đồ thống kê theo người đặt -->
                            <h4 class="mt-4 text-center">📊 Biểu đồ: Tổng tiền theo người đặt</h4>
                            ...
                            <script>
                                const userLabels = [
                                <% for (Object[] row : statsList) { %> "<%= row[0] %>", <% } %>
                                ];
                                const userData = [
                                <% for (Object[] row : statsList) { %> <%= row[3] %>, <% } %> // row[3] là tổng tiền
                                ];
                            ...
                            <!-- Biểu đồ tròn thống kê theo khách sạn -->
                            <h4 class="mt-4 text-center">📈 Biểu đồ: Tổng tiền theo khách sạn</h4>
                            ...
                            <script>
                                ...
                                const hotelData = [
                                <% for (Object[] row : statsList) { %> <%= row[2] %>, <% } %>
                                ];
                                const totalMoney = hotelData.reduce((a, b) => a + b, 0);
                                ...
                                type: 'pie',
                                        ...
                                        responsive: true,
                                                ...
                                                position: 'bottom'
                                                        ...
                                                        label: function(ctx) {
                                                        let value = ctx.raw;
                                                        let percentage = ((value / totalMoney) * 100).toFixed(1);
                                                        let formatted = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(value);
                                                        ...
                                                        color: '#fff',
                                                                ...
                                                                formatter: function(value) {
                                                                let percent = (value / totalMoney) * 100;
                                                                return percent.toFixed(1) + '%';
                                                                }
                                                        }
                                                }
