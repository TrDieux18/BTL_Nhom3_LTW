...
<html lang="vi">
    <head>
        ...
        <title>Danh sách khách sạn và vé máy bay</title>
    ...
    <body>
        ...
        <div class="container d-flex flex-column justify-content-center" style="padding-top:20px;">
        <h2 class="mb-2 text-dark" style="font-size: 25px;">Khuyến mãi không thể chịu thua</h2>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="2000" style="width: 1110px; height:auto;padding-top: 20px;border-radius: 10px; ">
