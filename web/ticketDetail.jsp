            ...
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="orderStatus" name="orderStatus" class="form-select form-select-custom" style="width: 100%; padding: 0.43rem; border-radius: 0.35rem; margin-top: 4px; border: 1px solid #ced4da;">
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- Phương thức thanh toán (nằm ngay dưới thông tin liên hệ) -->
                        <div class="description border rounded shadow-sm p-4 bg-white">
                            <h5 class="mb-3 text-dark" style="font-size: 25px;">Phương thức thanh toán</h5>
                            <c:choose>
