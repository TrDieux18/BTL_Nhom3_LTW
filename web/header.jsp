<%-- 
    Document   : header
    Created on : May 15, 2025, 6:55:26 PM
    Author     : pc
--%>
...
<% 
    User user = (User) session.getAttribute("user");
     List<Ticket> cartTickets = (List<Ticket>) session.getAttribute("cartTickets");
    List<HotelBooking> cartHotels = (List<HotelBooking>) session.getAttribute("cartHotels");
    int cartCount = 0;
    if (cartTickets != null) cartCount += cartTickets.size();
    if (cartHotels != null) cartCount += cartHotels.size();
%>
<html>
    <head>
    <meta charset="UTF-8" />
                ...
                <div class="col-12">
                    <div class="inner-main">
                        ...
                        <div class="inner-menu">
                            <div class="menu-left">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/ticket.jsp">Vé máy bay</a></li>
                            ...
                            <div class="menu-right">
                                <ul>
                                    <li><a href="y_cart"><i class="fa-solid fa-cart-shopping nav-item"></i></a></li>
                                    <%                                      
                                        if (user != null) {
                                        if(user.getRoleId()==2){
                                    %>
                                    <li style="position: relative;">
                                        <span id="userFullname" style="cursor:pointer;">
                                            <i class="fa-solid fa-circle-user nav-icon"></i>Xin chào, <span id="userFullN"><%= user.getFullname() %></span>
                                        </span>
    ...
    <div id="loginModal" class="modal">
        <div class="login-container">
            ...
            <form id="userLoginForm" method="post" action="login">
                ...
                <div id="alertError" class="alert alert-danger" style="display: <%= (loginError != null && loginError) ? "block" : "none" %>;" role="alert">
                    Tài khoản hoặc mật khẩu không đúng.
                </div>   
                <button style="width: 100%;" type="submit" class="btn btn-danger">Đăng Nhập</button>
                <a href="requestpassword" style="font-size:13px;display: flex; justify-content: flex-end; padding: 8px 0px;color: var(--color-red)">Quên mật khẩu</a>
                <div class="register-link">
                    Chưa có tài khoản? <a href="reg">Đăng ký</a>
                </div>
                <div class="login-link mt-3" style="font-size:13px;text-align: center; padding-bottom: 5px;">Hoặc đăng nhập bằng</div>
                <div class="d-flex gap-3 flex-column w-100 "style="font-size:16px;padding: 0px !important; ">
                  <a style="font-size:16px;padding: 5px !important; " href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:9999/BTLTest/loginn&response_type=code&client_id=923754187538-6vqp4klodso22mc6tf34nvmf2fcal3up.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-light border">
                    <img src="https://cdn.airpaz.com/cdn-cgi/image/w=50,h=50,f=webp/forerunner-next/img/socmed/google_logo.png"alt="Google"style="width: 17px; height: 17px;vertical-align: middle;" />
                    <span class="ms-2 fs-6"style="font-size:15px;padding: 0px !important; ">Google</span>
                  </a>              
                </div>
            </form>
        </div>
    </div>
    <script> const loginError = <%= (loginError != null && loginError) ? "true" : "false" %>;</script>
