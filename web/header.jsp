                            ...
                            <ul>
                                <li style="position: relative;">
                                    <a href="cart.jsp" class="position-relative">
                                        <i class="fa-solid fa-cart-shopping nav-item"></i>
                                        <% if (cartCount > 0) { %>
                                            <span class="badge bg-danger text-white rounded-circle position-absolute top-0 start-100 translate-middle" style="font-size: 12px; padding: 2px 6px;"><%= cartCount %></span>
                                        <% } %>
                                    </a>
                                </li>
                                    ...
                                    if (user.getRoleId() == 2) { %>
                                        <li style="position: relative;">
                                            ...
                                            <div id="userDropdown" class="user-dropdown" style="display:none;">
                                                <ul>
                                                    <li><a href="${pageContext.request.contextPath}/orders?action=get&id=<%= user.getId() %>"><i class="fa-solid fa-list"></i> Đơn hàng</a></li>
                                ...
                                <% } else if (user.getRoleId() == 1) { %>
                                        <li style="position: relative;">
                                            ...
                                            <div id="userDropdown" class="user-dropdown" style="display:none;">
                                                <ul>
                                                    <li><a href="${pageContext.request.contextPath}/management"><i class="fa-solid fa-list"></i> Quản lí</a></li>
                                                    <li><a href="profile"><i class="fa-solid fa-user"></i> Hồ sơ</a></li>
                                                    <li><a href="password"><i class="fa-solid fa-key"></i> Thay đổi mật khẩu</a></li>
                                                    <li class="logout"><a href="logout" id="logoutBtn"><i class="fa-solid fa-right-from-bracket"></i> Đăng xuất</a></li>
                                                </ul>
...
<div id="loginModal" class="modal">
    <div class="login-container">
        ...
        <form id="userLoginForm" method="post" action="login">
            ...
            <div class="register-link">Chưa có tài khoản? <a href="reg">Đăng ký</a></div>
        </form>
    </div>
</div>
